...
async function handleStep() {
  ...
  if (currentStep.value === 1) {
    currentStep.value = 2; // Move to Step 2 without API call
  } else {
...
async function handleRegistration() {
  ...
  try {
    ...
    const tenantPayload = {
      ...
      panOrGst: businessId.value || null,
    ...
    // Step 2: Create personal module
    const adminRoleId = "ea2303aa-1662-43ca-a7f7-ab84924a7e0a"; // Default Admin role ID
    ...
    // The hook handles other resources (folders, location, etc.)
